...
webix.protoUI({name:"webconsole",append:function(a){var b=this.config.template();b?this.setHTML(b+a):this.setHTML(a)},clear:function(){this.setHTML("")},defaults:{css:"web-console",borderless:!0,scroll:"y"}},webix.ui.template);
webix.protoUI({name:"mytemplate",reload:function(){let a=this;webix.ajax().get(this.config.src,{v:(new Date).getTime()}).then(function(b){a.setHTML(b.text());a.refresh()})},load:function(a){let b=this;webix.ajax().get(a,{v:(new Date).getTime()}).then(function(c){b.setHTML(c.text());b.refresh()})},defaults:{css:"mymetrics",borderless:!0}},webix.ui.template);
webix.protoUI({name:"echarts",$init:function(a){this.$view.innerHTML="<div style='width:100%; height:100%;'></div>";this._initChart(a)},$setSize:function(a,b){webix.ui.view.prototype.$setSize.call(this,a,b)&&this.getChart().resize()},_initChart:function(a){this._chart=echarts.init(this.$view.firstChild);this._chart.setOption(a.option)},getChart:function(){return this._chart}},webix.ui.view);
webix.attachEvent("onAjaxError",function(a){let b=/.*?message=(.*),\sinternal.*/.exec(a.responseText);b?webix.message({type:"error",text:b[1],expire:5E3}):webix.message({type:"error",text:a.responseText,expire:5E3})});webix.attachEvent("onLoadError",function(a,b){console.log(a.responseText);console.log(b.config)});tr=function(a,b){return window.GlobalTrans&&window.GlobalTrans[a]&&window.GlobalTrans[a][b]?window.GlobalTrans[a][b]:b};wxui.tr=tr;gtr=function(a){return tr("global",a)};
wxui.removeFromArray=function(a,b){for(var c=0;c<a.length;c++)a[c]===b&&a.splice(c,1)};markdown=new showdown.Converter;markdown.setOption("simplifiedAutoLink",!0);markdown.setOption("rawPrefixHeaderId",!0);markdown.setOption("rawHeaderId",!0);markdown.setOption("parseImgDimensions",!0);markdown.setOption("smoothLivePreview\u200e",!0);markdown.setOption("smartIndentationFix\u200e",!0);markdown.setOption("encodeEmails",!0);markdown.setOption("emoji",!0);markdown.setOption("tables",!0);
markdown.setOption("tablesHeaderId",!0);markdown.setOption("tasklists",!0);markdown.toHTML=function(a){a=markdown.makeHtml(a);setTimeout(function(){window.mermaid.init(void 0,document.querySelectorAll(".language-mermaid"))},1E3);return a};wxui.metricsColors="#f44336 #9c27b0 #3f51b5 #0288d1 #009688 #558b2f #ffa000 #ff5722 #795548 #546e7a #e91e63 #1e88e5".split(" ");
wxui.getPageToolbar=function(a){return{view:"toolbar",paddingX:10,css:"page-toolbar",hidden:a.hidden||!1,cols:[{view:"label",label:" <i class='mdi mdi-"+a.icon+"'></i> "+a.title,css:"dash-title-b",width:150,align:"left"},{},{cols:a.elements}]}};wxui.getIconButton=function(a,b,c,d,e){return{view:"button",type:"icon",css:"webix_transparent",inputWidth:b,width:b,icon:"mdi mdi-"+c,label:a,hidden:d,click:e}};
wxui.getIconButton2=function(a,b,c,d,e,f){return{view:"button",type:"icon",css:"webix_transparent",inputWidth:b,width:b,height:c,icon:"mdi mdi-"+d,label:a,hidden:e,click:f}};wxui.getPrimaryButton=function(a,b,c,d){return{view:"button",css:"webix_primary",inputWidth:b,width:b,label:a,hidden:c,click:d}};wxui.getDangerButton=function(a,b,c,d){return{view:"button",css:"webix_danger",inputWidth:b,width:b,label:a,hidden:c,click:d}};
wxui.getTableCheckedIds=function(a){let b=[];$$(a).eachRow(function(c){(c=$$(a).getItem(c))&&1===c.state&&b.push(c.id)});return b};wxui.getTableCheckedAttrs=function(a,b){let c=[];$$(a).eachRow(function(d){(d=$$(a).getItem(d))&&1===d.state&&c.push(d[b])});return c};wxui.getTableChecked_Ids=function(a){let b=[];$$(a).eachRow(function(c){(c=$$(a).getItem(c))&&1===c.state&&b.push(c._id)});return b};
...
wxui.getDatatable=function(a){let b={id:a.tableid,css:"main-panel-box",view:"datatable",type:a.type||{},headermenu:!0,select:!0,resizeColumn:!0,autoWidth:!0,autoHeight:!0,on:a.on||{},onClick:a.onClick||{}};b.leftSplit=void 0!==a.leftSplit?a.leftSplit:1;void 0!==a.datafetch&&(b.datafetch=a.datafetch);void 0!==a.subrow&&(b.subrow=a.subrow);void 0!==a.loadahead&&(b.loadahead=a.loadahead);void 0!==a.fixedRowHeight&&(b.fixedRowHeight=a.fixedRowHeight);void 0!==a.rowLineHeight&&(b.rowLineHeight=a.rowLineHeight);
void 0!==a.scrollX&&(b.scrollX=a.scrollX);b.editable=void 0!==a.editable?a.editable:!1;b.rightSplit=void 0!==a.rightSplit?a.rightSplit:1;a.autoConfig?b.autoConfig=a.autoConfig:b.columns=a.columns;a.pager&&(b.pager=a.tableid+".dataPager");a.url&&(b.url=a.url);a.save&&(b.save=a.save);a.data&&(b.data=a.data);a.subview&&(b.subview=a.subview);return b};
...
click:function(){webix.fullscreen.set($$(b))}},{view:"icon",icon:"mdi mdi-close",css:"alter",click:function(){webix.fullscreen.exit();$$(b).close()}}]},body:{rows:[{id:c,view:"form",scroll:!0,elementsConfig:a.elementsConfig||{labelWidth:100},elements:a.elements,data:a.data||{}},{padding:5,cols:[{},{view:"button",name:"submit",type:"form",value:tr("global","\u63d0\u4ea4"),width:120,height:36,click:function(){if(!$$(c).validate())return webix.message({type:"error",text:tr("global","\u8bf7\u586b\u5199\u6709\u6548\u6570\u636e"),
expire:1E3}),!1;let d=$$(c).getValues();a.callBefore&&(d=a.callBefore(d));webix.ajax().post(a.post,d).then(function(e){e=e.json();webix.message({type:e.msgtype,text:e.msg,expire:5E3});0===e.code&&($$(b).close(),a.callback&&a.callback())})}},{view:"button",css:"webix_transparent",icon:"mdi mdi-close",width:70,label:tr("global","\u53d6\u6d88"),click:function(){$$(b).close()}}]}]}})}};
...
wxui.getForm=function(a){webix.uid();let b=a.formid||webix.uid(),c=a.winid||webix.uid();return{id:c,css:"main-panel",padding:10,rows:[{view:"toolbar",css:"page-toolbar",cols:[{view:"icon",icon:"mdi mdi-square-edit-outline"},{view:"label",label:a.title},{},a.actions||{cols:[{view:"button",css:"webix_primary",label:tr("global","Save"),width:120,height:36,click:function(){if($$(b).validate()){var d=$$(b).getValues();webix.ajax().post(a.post,d).then(function(e){e=e.json();webix.message({type:e.msgtype,
text:e.msg,expire:5E3});0===e.code&&($$(bss.core.tabsId).removeOption(c),wxui.removeFromArray(bss.core.tabsIds,c),a.parentid&&$$(bss.core.tabsId).setValue(a.parentid),a.callback&&a.callback(e))})}else webix.message({type:"error",text:tr("global","Please fill in the valid data."),expire:1E3})}},{view:"icon",icon:"mdi mdi-fullscreen",css:"alter",click:function(){webix.fullscreen.set($$(c))}}]}]},{id:b,view:"form",css:"detail-form",scroll:!0,elementsConfig:a.elementsConfig||{labelWidth:120,bottomPadding:a.bottomPadding||
...
wxui.confirmCall=function(a,b,c){a?webix.confirm({title:"\u64cd\u4f5c\u786e\u8ba4",ok:"Yes",cancel:"No",text:b||"\u786e\u8ba4\u6b64\u64cd\u4f5c\u5417?",callback:function(d){d&&c()}}):c()};wxui.displayTableMessage=function(a,b,c,d,e){webix.ui({view:"popup",height:c,width:b,scroll:"auto",body:{name:"content",view:"codemirror-editor",mode:e,value:d}}).show(a)};wxui.statusOptions=[{id:"1",value:"\u6b63\u5e38"},{id:"0",value:"\u7981\u7528"}];
wxui.mqttQosOptions=[{id:"0",value:"\u6700\u591a\u4e00\u6b21"},{id:"1",value:"\u6700\u5c11\u4e00\u6b21"},{id:"2",value:"\u53ea\u6709\u4e00\u6b21"}];wxui.mqttClearSessionOptions=[{id:"0",value:"\u6301\u4e45\u4f1a\u8bdd"},{id:"1",value:"\u79bb\u7ebf\u81ea\u52a8\u9500\u6bc1"}];wxui.mqttRetainOptions=[{id:"0",value:"\u4e0d\u4fdd\u7559"},{id:"1",value:"\u4fdd\u7559"}];
