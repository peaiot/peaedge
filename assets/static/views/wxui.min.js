...
wxui.openSideWindow=function(a){let b=a.winid;$$(b)&&$$(b).isVisible()?$$(b).close():webix.ui({view:"sidemenu",id:b,width:a.width||420,position:"right",state:function(c){let d=$$(a.parentId).$height;c.top=d;c.height-=d},body:{rows:[{css:"panel-toolbar",paddingX:10,cols:[{view:"icon",icon:"mdi mdi-information-outline",css:"alter webix_transparent"},{view:"label",label:a.title,css:"dash-title-b",inputWidth:150,align:"left"},{},{view:"icon",icon:"mdi mdi-close",css:"webix_transparent",click:function(){$$(b).close()}}]},
{view:"scrollview",body:a.body}]}}).show()};wxui.initUploadApi=function(a,b,c){webix.ui({id:a,view:"uploader",upload:b,on:{onBeforeFileAdd:function(d){d.formData={};webix.message({type:"info",text:tr("global","Upload..."),expire:3E3})},onFileUpload:function(d){c&&c(d)},onFileUploadError:function(d,e){webix.message({type:"error",text:tr("global","Upload failure"),expire:3E3})},onUploadComplete:function(d){webix.message({type:d.msgtype,text:d.msg,expire:5E3})}},apiOnly:!0})};
